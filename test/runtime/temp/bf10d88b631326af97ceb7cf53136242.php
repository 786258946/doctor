<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\phpstudy\PHPTutorial\WWW\test\public/../application/admin\view\shop\goods\add.html";i:1607413782;s:75:"D:\phpstudy\PHPTutorial\WWW\test\application\admin\view\layout\default.html";i:1588765312;s:72:"D:\phpstudy\PHPTutorial\WWW\test\application\admin\view\common\meta.html";i:1588765312;s:74:"D:\phpstudy\PHPTutorial\WWW\test\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-title" class="form-control" name="row[title]" type="text" placeholder="请填写商品名称" data-rule="required">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-cover_img" class="form-control" size="35" name="row[cover_img]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-banner_img" class="form-control" size="35" name="row[banner_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-now_price" class="form-control" name="row[now_price]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Old_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-old_price" class="form-control" name="row[old_price]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('运费'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-fre_price" class="form-control" name="row[fre_price]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[state]',['1'=>__('上架'), '0'=>__('下架')]); ?>
        </div>
    </div>
    <div class="form-group">
